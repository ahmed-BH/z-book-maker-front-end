...
export const confidanceToColorMap = [
  ...
  { check: (confidance) => confidance < 70, color: error.main, label: '< 70%' },
  { check: (confidance) => confidance < 80, color: error.light, label: '< 80%' },
  { check: (confidance) => confidance < 90, color: warning.main, label: '< 90%' },
  { check: (confidance) => confidance <= 100, color: success.main, label: '<= 100%'},
];
